...
class ConfigConstant {
  ...
  /// ```dart
  /// sizedBoxH2 = SizedBox(height: 24.0);
  /// ```
  static const SizedBox sizedBoxH3 = SizedBox(height: 24.0);
  /// ```dart
  /// sizedBoxH4 = SizedBox(height: 32.0);
  /// ```
  static const SizedBox sizedBoxH4 = SizedBox(height: 32.0);
  /// ```dart
  /// sizedBoxH4 = SizedBox(height: 44.0);
  /// ```
  static const SizedBox sizedBoxH5 = SizedBox(height:44.0);
  ...
  /// 450
  static const double screenMaxWidth = 450.0; 
}
